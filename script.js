...
tabsContainer.addEventListener('click', function (e) {
  ...
  // Remove active classes for both tab and active content
...
const initialCords = selection1.getBoundingClientRect();
...
message.textContent = `we use cokkie for improved functionality and analytic`;

message.innerHTML = `we use cookied for improved functionality and analytic, <button class="btn btn--close-cookie">Got it!</button>`;
...
btnScrollTo.addEventListener('click', function (e) {
  ...
  console.log('current scroll (x/y)', window.pageXOffset, window);
...
document.addEventListener('load', function (e) {
  console.log('load event fully load', e);
});
